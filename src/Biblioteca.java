...
public class Biblioteca {
    ...
    /**
     * @param cantidadLibros //The number of books available in the library
     * @param cantidadEquipos //The quantity of equipments available in the
     * library
     * @param nombre //Library name
     */
