...
public class Devolution {
     ...
     */
    public Devolution(int id_loan, Date date, Date deliverDate, String exemplars
    ...
    public static void search(TextField searchDevolution,
            TableView<Devolution> tableView) {
        FilteredList<Devolution> filteredData = new FilteredList<>(tableView.
                getItems(), p -> true);
        ...
        SortedList<Devolution> sortedList = new SortedList<>(filteredData);
