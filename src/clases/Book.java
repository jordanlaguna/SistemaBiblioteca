...
public class Book {
    ...
    public Book(Integer isbn, String title, String authorBook, 
    ...
    public void searchBook(TextField txt_search, TableView<Book> tableView){
         FilteredList<Book> filterData = new FilteredList<>(tableView.
                getItems(), p -> true);
        ...
        SortedList<Book> sortedList = new SortedList<>(filterData);
